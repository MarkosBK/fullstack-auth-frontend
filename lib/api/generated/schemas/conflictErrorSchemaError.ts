 ...
 */
import type { ConflictErrorSchemaErrorMessage } from './conflictErrorSchemaErrorMessage';

export type ConflictErrorSchemaError = {
  message?: ConflictErrorSchemaErrorMessage;
  timestamp?: string;
  path?: string;
  method?: string;
};
